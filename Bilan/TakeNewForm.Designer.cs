namespace Bilan
{
	partial class TakeNewForm
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(TakeNewForm));
			...
			this.textBox1.Location = new System.Drawing.Point(280, 263);
			...
			this.comboBox1.Location = new System.Drawing.Point(280, 164);
			...
			this.label2.Text = "Name of the supplier";
			// 
			// dateTimePicker1
			// 
			...
			this.Name = "TakeNewForm";
			this.Text = "TakeNewForm";
